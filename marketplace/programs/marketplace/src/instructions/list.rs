...
pub struct List<'info> {
    ...
    maker_ata: Box<InterfaceAccount<'info, TokenAccount>>, //where the nft originally is
    #[account(
        init_if_needed,
        payer = maker,
        associated_token::mint = maker_mint,
    ...
    vault: Box<InterfaceAccount<'info, TokenAccount>>, //where the nft is going to be when listed
    #[account(
        init,
        payer = maker,
