...
impl<'info> Unstake<'info> {
    pub fn unstake(&mut self) -> Result<()> {
        ...
        self.user_account.points += time_elapsed as u32 * self.config.points_per_user as u32;
        ...
        //stake account unfreezes the nft
        ...
        //authority of the nft is given back to the user
        revoke(cpi_ctx)?;
